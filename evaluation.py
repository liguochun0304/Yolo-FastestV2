...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/traffic-150-epoch-0.318521ap-model.pth',
    ...
    print("val_data:%s"%(cfg["val_data"]))
    print("model_path:%s"%(opt.weights))
    
    #加载数据
    val_dataset = utils.datasets.TensorDataset(cfg["val_data"], cfg["width"], cfg["height"], imgaug = False)
