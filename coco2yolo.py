...
if __name__ == '__main__':
    ...
    parser.add_argument('--images_path', default='D:\git_km\Yolo-FastestV2\dataset/val2017', type=str)
    parser.add_argument('--json_file', default='D:\git_km\Yolo-FastestV2/annotations_trainval2017/annotations\instances_val2017.json', type=str)
    parser.add_argument('--ana_txt_save_path', default='D:\git_km\Yolo-FastestV2\dataset/val2017', type=str)
    parser.add_argument('--out_txt_path', default='D:\git_km\Yolo-FastestV2\dataset/val_data.txt', type=str)
