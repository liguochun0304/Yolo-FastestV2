...
class TensorDataset():
    def __init__(self, path, img_size_width = 320, img_size_height = 240, imgaug = False):
        ...
        with open(self.path, 'r') as f:
            for line in f.readlines():
                ...
                data_path = 'D:\git_km\Yolo-FastestV2\dataset//' + data_path
...
if __name__ == "__main__":
    data = TensorDataset("D:\git_km\Yolo-FastestV2\dataset/val.txt")
